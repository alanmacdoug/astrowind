...
1. **Monitor (p=none):** the record instructs receiving systems to accept unauthenticated mail but report it to you. You receive aggregate reports showing who is sending email as your domain — legitimate platforms, and impostors. This is reconnaissance: you cannot fix what you cannot see.
...
3. **Reject:** unauthenticated mail is refused outright. Impostor email from your domain simply stops arriving. This is where spoofing ends — not mitigated, ended.
