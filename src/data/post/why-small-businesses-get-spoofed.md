...
- **Smaller supplier networks have softer procedures.** An invoice-redirection email works when the recipient is used to paying invoices from you without secondary verification.
...
- **CEO fraud.** Staff receive an email that appears to come from a director, urgent and confidential, requesting a payment or sensitive data. The request plays on hierarchy and time pressure precisely because it cannot survive scrutiny.
...
1. **Check what protection you already have.** The [email authentication checker](/tools/auth-checker) inspects your domain's SPF, DKIM and DMARC records and interprets them in plain English.
...
If reading DNS records and reconciling senders sounds like a job rather than an afternoon, that is because it can be. A [DMARC record read](/contact) is a flat-fee service that starts with your existing records and reports, and tells you exactly where you stand and what the safe next step is: fixed price, no further obligation.

## The uncomfortable summary

The identity customers trust, your email address and your domain, is currently usable by anyone on the internet, unless you have deliberately made it otherwise.

Business email compromise exists because spoofing is free where DMARC is absent. The defence is established and standard, and it costs less than a single successful invoice-redirection against one of your suppliers.
